...
df_yellow.rename(columns={"ISIN kode": "ISIN", 
                            "Årsag":"Årsag til eksklusion",
                            "Værdipapirets navn":"Matched Værdipapirets navn",
                            "Udsteder": "Selskab",
                            }, inplace=True)
df_yellow.drop('Type', axis=1, inplace=True)
df_yellow['Årsag til eksklusion'] = "Gravercentret: " + df_yellow['Årsag til eksklusion'].astype(str)
...
merged_df = pd.merge(df_kilde, df_final_isin_lists, how="left", left_on="ISIN kode", right_on="ISIN")
